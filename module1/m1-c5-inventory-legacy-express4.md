...
to the project name and the Local badge. It must read `demo/m1-c5-start`. On the run that found this it read
...
`demo/m1-c5-start`. Compare the whole path: the two folders differed only in a parent directory, so any
