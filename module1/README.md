...
It writes a one-page report to `module1/logs/m1-c2_preflight.txt`, grouped by that clip's four
steps, each marked READY or BLOCKED. `module1/scripts/preflight_check.sh` with no argument runs
