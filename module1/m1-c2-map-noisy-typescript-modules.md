...
It must end `PASS: m1-c2 is ready.` Anything else names the check, why it matters, and the
command that fixes it — fix that before recording.

The report lands in `module1/logs/m1-c2_preflight.txt`, one page grouped by this clip's four
steps.
